...
cf set-env slackbot DOWNLOAD_REDIS_SLACK_TOKEN token5
cf set-env slackbot DOWNLOAD_REDIS_RC_SLACK_TOKEN token6
cf set-env slackbot DOWNLOAD_SECRETS_SLACK_TOKEN token7
