...
func init() {
	r := &bot{}
	robots.RegisterRobot("download-haproxy-rc", r)
}
...
func (r bot) Run(p *robots.Payload) string {
	...
	return "Wisened old dingos are building a URL just for you for the latest internal Dingo HAProxy release-candidate tile."
}
