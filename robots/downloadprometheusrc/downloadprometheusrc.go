...
func init() {
	r := &bot{}
	robots.RegisterRobot("download-prometheus-rc", r)
}
...
func (r bot) Run(p *robots.Payload) string {
	...
	return "Wisened old dingos are building a URL just for you for the latest internal Dingo Prometheus release-candidate tile."
}
