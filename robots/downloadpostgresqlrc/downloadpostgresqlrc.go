...
func init() {
	r := &bot{}
	robots.RegisterRobot("download-postgresql-rc", r)
}
...
func (r bot) Run(p *robots.Payload) string {
	...
	return "Wisened old dingos are building a URL just for you for the latest internal Dingo PostgreSQL release-candidate tile."
}
...
func (r bot) DeferredAction(p *robots.Payload) {
	...
	productName := "Dingo PostgreSQL"
	productLabel := "dingo-postgresql"
...
func (r bot) Description() string {
	...
	return "Fetch URL to download latest Dingo PostgreSQL tile."
}
