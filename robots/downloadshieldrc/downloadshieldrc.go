...
func init() {
	r := &bot{}
	robots.RegisterRobot("download-shield-rc", r)
}
...
func (r bot) Run(p *robots.Payload) string {
	...
	return "Wisened old dingos are building a URL just for you for the latest internal Dingo Shield release-candidate tile."
}
