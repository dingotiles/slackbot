...
func init() {
	r := &bot{}
	robots.RegisterRobot("download-kafka-rc", r)
}
...
func (r bot) Run(p *robots.Payload) string {
	...
	return "Wisened old dingos are building a URL just for you for the latest internal Dingo Kafka release-candidate tile."
}
