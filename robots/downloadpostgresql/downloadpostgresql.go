...
func init() {
	r := &bot{}
	robots.RegisterRobot("download-postgresql", r)
}
...
func (r bot) Run(p *robots.Payload) string {
	...
	return "Baby dingos are building a URL just for you for the latest Dingo PostgreSQL tile."
}
